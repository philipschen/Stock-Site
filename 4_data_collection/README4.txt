...
3 - The MyPortfolio Database: MyPortfolioDBPDO.

4 - The MyPortfolio Table in MyPortfolioDBPDO which will containg all the portfolio data
...
5 - The User Database: UserDBPDO.

6 - The Users Table in UserDBPDO which will contain information for all the registered users of the system.
