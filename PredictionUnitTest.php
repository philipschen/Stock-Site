...
// Get which Stock
/*
$predictioncheck=fopen("predictioncheck.txt", or die("Prediction file unaccessible");
$txt="Prediction class accessible\n";
fwrite($predictioncheck, $txt);  //TEST FOR PREDICTION CHECK */
...
$RSIcheck=fopen("RSIcheck.txt", or die("RSI file unaccessible");
$txt="RSI class accessible\n";
fwrite($RSIcheck, $txt);  //TEST FOR RSI CHECK
...
/*
$patterncheck=fopen("patterncheck.txt", or die("Pattern file unaccessible");
$txt="Pattern class accessible\n";
fwrite($patterncheck, $txt);  // TEST FOR PATTERN CHECK */
