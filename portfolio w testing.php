...
<?php
// $integrationFile=fopen("Portfolio_Integration.txt", or die("Integration file unaccessible");
// $txt="Portfolio class accessible\n";
// fwrite($integrationFile, $txt);  //TEST
